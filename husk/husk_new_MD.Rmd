...
```{r}
husk.data <- Read10X(data.dir = "/Users/xiaoyizheng/Downloads/Praktikum/Bioinfo_Einarbeiten/CellChatSelf/mouse/GSE113854_RAW/")
#husk.data

husk <- CreateSeuratObject(counts = husk.data, project = "husk", min.cells = 3, min.features = 200)
husk
```
...
husk <- FindClusters(husk, resolution = 0.3) #13 clusters aus paper #res = 0.3 cluster 0->12
head(Idents(husk), 5)
```
